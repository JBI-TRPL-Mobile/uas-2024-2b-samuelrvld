...
class _ProfileScreenState extends State<ProfileScreen> {  
  ...
  Future<void> _loadUser() async {  
    try {  
      final String response = await rootBundle.loadString('assets/datauser.json'); // Pastikan path ini sesuai  
      ...
      body: user == null  
          ...
          : ListView(  
              ...
              children: [  
                  ...
                  child: Container(  
                    ...
                    decoration: BoxDecoration(  
                      ...
                      image: DecorationImage(  
                        image: AssetImage(user!.profilePicture), // Pastikan profilePicture ada di model User  
                        fit: BoxFit.cover,  
                      ),  
                    ),  
                  ),  
                ...
                SizedBox(height: 20),  
                Text(  
                  user!.fullName, // Pastikan nama atribut di model User sesuai  
